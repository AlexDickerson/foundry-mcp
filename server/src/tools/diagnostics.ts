...
export function registerDiagnosticTools(mcp: McpServer): void {
  mcp.registerTool('get_logs', {
    title: 'Get Server Logs',
    description: 'Retrieve recent foundry-mcp server log entries. Useful for debugging command failures, timeouts, and connection issues.',
    inputSchema: {
  ...
  mcp.registerTool('get_server_status', {
    title: 'Server Status',
